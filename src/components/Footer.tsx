        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-2xl font-bold">Prajatha</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Your trusted partner for premium food and lifestyle products. 
              From snacks to corporate solutions, we deliver quality and satisfaction.
            </p>
            <div className="space-y-2">
              <div className="flex items-center space-x-3 text-gray-300">
                <Mail className="h-5 w-5 text-emerald-400" />
                <span>support@prajatha.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <Phone className="h-5 w-5 text-emerald-400" />
                <span>+91 6363 031 355</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <MapPin className="h-5 w-5 text-emerald-400" />
                <span>Basaveshwaranagar, Bangalore - 560079</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>Snack Foods</li>
              <li>Dry Fruits</li>
              <li>Sweets & Confectionaries</li>
              <li>Coffee & Tea</li>
              <li>Spices & Condiments</li>
              <li>Frozen Foods</li>
              <li>Textiles</li>
              <li>Corporate Bags</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm mb-4 md:mb-0">
              © 2025 Prajatha. All rights reserved.
            </p>
            <div className="flex items-center space-x-1 text-gray-300 text-sm">
              <span>Made with</span>
              <Heart className="h-4 w-4 text-red-400" />
              <span>for quality and taste</span>
            </div>
          </div>
        </div>
      </div>
